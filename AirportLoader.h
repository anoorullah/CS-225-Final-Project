...
public:
    ...
    AirportLoader(string flight, string start, string end); 
    ...
    void setWeight(double first_ns, double first_ew, double second_ns, double second_ew); // Setting spherical weights as suggested by Amit
